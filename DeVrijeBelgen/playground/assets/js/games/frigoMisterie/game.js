class Game extends Phaser.Scene {
  ...
  create ()
  {
    ...
    this.scoreText = this.add.text(16, 16, 'Score: 0', { fontSize: (32* window.devicePixelRatio)+'px', fill: '#FFF' });
    this.missersText = this.add.text(16, this.scoreText.height, 'Missers: 0', { fontSize: (32* window.devicePixelRatio)+'px', fill: '#FFF' });
